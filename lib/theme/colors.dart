...
ThemeData buildDarkTheme() {
  return ThemeData(
    ...
    // Chips and dialogs use light C.* palette to match screen hardcoding.
    chipTheme: const ChipThemeData(
      backgroundColor: C.surface,
      selectedColor: C.accentLight,
      secondarySelectedColor: C.accentLight,
      labelStyle: TextStyle(color: C.text),
      secondaryLabelStyle: TextStyle(color: C.text),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      labelStyle: const TextStyle(color: Color(0xFF8A7460), fontWeight: FontWeight.w500),
